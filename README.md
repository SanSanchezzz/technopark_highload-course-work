...
Считая, что один сервер может распологать двумя сетевыми картами, получается: `86 / 2 = 43 сервера`. Для обеспечения наибольшей надёжности будем брать 50 серверов, которые стоит географически равномерно распределить между штатами и европой.
