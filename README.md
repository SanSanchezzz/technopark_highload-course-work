...
| ---------------------------------------- | ------- | --------- | ------------ | ---------- |
| Управляющий сервис                       | 96 (×2) | 32 Гбайт  | 480 Гбайт    | 1        |
| СУБД                                     | 32 (×2) | 16 Гбайт  | 128 Гбайт    | 1         |
| Хост звонков                             | 96 (×2) | 128 Гбайт | 480 Гбайт    | 5 730     |

Сервера для хостов звонков следует равномерно распределить в Европе и США. Управляющий сервис и СУБД расположим в США, так как именно там находится большинство пользоватлей.
